...
struct Demo : Application {
    ...
    glm::vec3 _t = { 0,0,0 }, _r = { 0,0,0 }, _sc = { 1,1,1 };
    bool _auto = false;
    ...
    void renderFrame() override {
        ...
        M = glm::rotate(M, _r.x, glm::vec3(1, 0, 0));
        M = glm::rotate(M, _r.y, glm::vec3(0, 1, 0));
        M = glm::rotate(M, _r.z, glm::vec3(0, 0, 1));
        ...
        ImGui::SliderFloat3("Translate", &_t[0], -3, 3);

        ImGui::SliderFloat3("Rotate", &_r[0], -6.28f, 6.28f);
        ImGui::SliderFloat3("Scale", &_sc[0], 0.1f, 3);

        ImGui::Checkbox("Auto Rotate Y", &_auto);
